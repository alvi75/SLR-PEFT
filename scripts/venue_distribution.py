...
# Define the exact order and values
...
# Adjust the x-axis limit to ensure ASE bar aligns with the X-axis
...
ax.set_ylabel("Venue")  # Remove "Venue" label
...
# Ensure ASE fully overlaps with the X-axis
ax.set_ylim(-0.5, len(df_reversed) - 0.5)  # Shifts all names down
